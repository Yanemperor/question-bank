...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/download/list.vue */ 182));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // @ts-ignore
...
/* harmony import */ var _list_vue_vue_type_template_id_61007f9c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=61007f9c& */ 183);
  ...
  methods: {
    ...
    getDownloadList: function getDownloadList() {var _this = this;
      ...
      get().then(function (res) {
        ...
        var temps = [];
        res.result.data[0].items.map(function (item, index) {
          temps.push(Object.assign(item, {
            "tempFilePath": "" }));

        });
        _this.questionList = temps;
      }).catch(function (e) {
